...
// Getters
const std::string &DumbSed::getFilename() const {
	return _filename;
}

const std::string &DumbSed::getOutFilename() const {
	return _outFilename;
}

const std::string &DumbSed::getS1() const {
	return _s1;
}

const std::string &DumbSed::getS2() const {
	return _s2;
}

const std::ifstream &DumbSed::getInfile() const {
	return _infile;
}

const std::ofstream &DumbSed::getOutfile() const {
	return _outfile;
}
